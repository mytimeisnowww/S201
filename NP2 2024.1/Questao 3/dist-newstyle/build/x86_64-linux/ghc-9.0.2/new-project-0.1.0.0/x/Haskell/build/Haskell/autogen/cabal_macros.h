...
#ifndef VERSION_new_project
#define VERSION_new_project "0.1.0.0"
#endif /* VERSION_new_project */
#ifndef MIN_VERSION_new_project
#define MIN_VERSION_new_project(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_new_project */
...
#define CURRENT_COMPONENT_ID "new-project-0.1.0.0-inplace-Haskell"
